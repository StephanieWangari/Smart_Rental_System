...
@section('content')
<div class="mb-5">
    <a href="{{ route('tenants.index') }}" class="text-green-600 dark:text-green-400 hover:underline text-sm">← Back to Tenants</a>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow border border-gray-100 dark:border-gray-700 overflow-hidden">
        ...
        <div class="px-6 py-4 space-y-3 text-sm divide-y divide-gray-100 dark:divide-gray-700">
            ...
            <div class="flex justify-between py-1"><span class="text-gray-500 dark:text-gray-400">Monthly Rent</span><span class="font-bold text-green-600 dark:text-green-400">KES {{ number_format($tenant->property->rent_amount, 2) }}</span></div>
        </div>
    </div>
</div>
