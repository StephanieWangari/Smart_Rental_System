...
<div class="max-w-xl">
    ...
    <form method="POST" action="{{ route('tenants.update', $tenant) }}"
        ...
        <div>
            ...
            <select name="status"
                    class="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 text-sm">
